...
//frequency of linescan data update in uS
#define DEFAULT_LINESCAN_EXPOSURE_TIME_uS 10000

#define LINESCAN0_CHANNEL	6
#define BAT_SENSE_CHANNEL	4
// add other ADC channels here
